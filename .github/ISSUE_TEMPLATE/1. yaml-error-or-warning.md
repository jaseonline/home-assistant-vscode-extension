...
1.  Is it an YAML parsing error?
    ...
    In doubt? Read more:
    https://github.com/keesschollaart81/home-assistant-vscode/wiki/Is-it-the-YAML-parser%3F

2.  Is a HA scheme error?

    Feel free to fix this yourself, it's quite easy, HowTo here:
    https://github.com/keesschollaart81/home-assistant-vscode/wiki/HowTo:-Update-the-schema's
